			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<img class="img-responsive" src="images/1.dental.png"
							alt="First slide">
						<div class="container">
					...
					<div class="item">
						<img class="img-responsive" src="images/2.clean.png"
							alt="First slide">
						<div class="container">
							<div class="carousel-caption">
					...
					<div class="item">
						<img class="img-responsive" src="images/3.instruments.png"
							alt="First slide">
						<div class="container">
							<div class="carousel-caption">
								<h1>Another example headline.</h1>
				...
				<div
					...
					<div class="row text-center">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<%
								for (Produse produs : ProduseController.getAllProducts()) {
							%>
							<div class="col-xs-12 col-sm-6 col-md-6 productpadding">
								<img class="img-rounded pull-right" src="images/1.dental.png"
									alt="Image" title="Image" width="125" height="103" />
								<div class=" pull-left">
									<h4>
										<a href="#"><%=produs.getName().substring(0, 15)%>...</a>
									</h4>
									<h5>
										<a href="#"><%=produs.getPrice()%></a>
									</h5>
								</div>
							</div>
							<%
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 text-center">
					...
					<p>
						<a href="contact.jsp">feedback@dentalproducts.com</a>
					</p>
				</div>
			</div>
		</div>
